...
# TODO
revenue_df = events_df.withColumn("revenue", col("ecommerce.purchase_revenue_in_usd").cast("double"))
display(revenue_df)
...
# TODO
final_df = (events_df
  .withColumn("revenue", col("ecommerce.purchase_revenue_in_usd").cast("double"))
